    ...
    <header className="bg-card border-b border-border">
      <div className="container mx-auto p-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-500 to-green-500 bg-clip-text text-transparent">
              Government Subsidized Care Management
            </h1>
          </div>

          <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
            <div className="relative w-full sm:w-64">
              <Input type="text" placeholder="Search patient, scheme, or status" className="pl-10 w-full" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
          ...
          <div className="bg-card/50 rounded-lg p-4 border border-border">
            <div className="text-sm text-muted-foreground">Subsidy Approved</div>
            <div className="text-2xl font-bold text-green-500">1,245</div>
          </div>
          <div className="bg-card/50 rounded-lg p-4 border border-border">
            <div className="text-sm text-muted-foreground">Pending Approval</div>
            <div className="text-2xl font-bold text-amber-500">720</div>
          </div>
        </div>
      </div>
    </header>
