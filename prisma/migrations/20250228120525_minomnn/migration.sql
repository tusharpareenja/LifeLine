/*
  ...
  - The required column `user_id` was added to the `credentials` table with a prisma-level default value. This is not possible if the table is not empty. Please add this column as optional, then populate it before making it required.

*/
-- DropForeignKey
ALTER TABLE "credentials" DROP CONSTRAINT "credentials_email_fkey";
